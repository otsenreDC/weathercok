 ...
 */
public class WindFragment extends Fragment implements Vane.VaneListener {
    ...
    private void setVane(Double speed, Double direction) {

        this.vane.setDirection(direction);
        this.vane.setSpeed(speed);
    }
